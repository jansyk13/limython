...
declare -a arr=("-a=normalize=False,fit_intercept=False"
                ...
                "-a=normalize=False,fit_intercept=False -u=true -f=method,url,payload_size"
                "-a=normalize=True,fit_intercept=False -u=true -f=method,url,payload_size"
                "-a=normalize=False,fit_intercept=True -u=true -f=method,url,payload_size"
                "-a=normalize=True,fit_intercept=True -u=true -f=method,url,payload_size"
                )
