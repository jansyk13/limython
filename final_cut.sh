...
declare -a arr=(
                "-l=1000 -a=criterion=mse,splitter=random,max_depth=20,max_features=log2 -u=true -ul=8"
                "-l=10000 -a=criterion=mse,splitter=random,max_depth=20,max_features=log2 -u=true -ul=8"
                "-l=50000 -a=criterion=mse,splitter=random,max_depth=20,max_features=log2 -u=true -ul=8"
                ...
                "-l=1000 -a=criterion=mse,splitter=best,max_depth=20,max_features=log2 -u=true -ul=8"
                "-l=10000 -a=criterion=mse,splitter=best,max_depth=20,max_features=log2 -u=true -ul=8"
                "-l=50000 -a=criterion=mse,splitter=best,max_depth=20,max_features=log2 -u=true -ul=8"
                ...
                "-l=1000 -a=criterion=mse,splitter=random,max_depth=20,max_features=sqrt -u=true -ul=8"
                "-l=10000 -a=criterion=mse,splitter=random,max_depth=20,max_features=sqrt -u=true -ul=8"
                "-l=50000 -a=criterion=mse,splitter=random,max_depth=20,max_features=sqrt -u=true -ul=8"
